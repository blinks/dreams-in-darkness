...
Weigh everything on the scales and come up with an obvious, interesting outcome.  Then draw:

- If you draw major arcana, a relic is found.  Contact the player attuned to it and ask what it looks like and how to unlock its power.  Someone involved in this conflict finds it, but doesn't know what it is or how it works.
- If you draw a court card (page, knight, queen, or king), an important character appears.  Perhaps a new cultist, perhaps just someone important to the setting.  Figure out who they are.
- If you draw an ace, the plan succeeds wildly, and the attackers gain power; give them new aspects reflecting their growth in the sphere of conflict.

No matter what you draw, reflect on the image and what it might mean, updating your outcome with that understanding.  Contact the player with the situation from the cultists perspective, and pick another conflict to resolve.  Responses come only when the cultist is dreaming -- and might take a while.  Life goes on above.
