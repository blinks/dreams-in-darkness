...
The Sun:: A conflict of raw power or strength (Swords and Pentacles).

Mercury:: A conflict of speed or skill (Wands and Swords).

Venus:: A conflict of persuasion (Wands and Cups).

The Moon:: A conflict of wisdom, secrets, or magic (Cups and Swords).

Mars:: A conflict of courage or constitution (Wands and Pentacles).

Saturn:: A conflict of patience or solitude (Cups and Pentacles).
