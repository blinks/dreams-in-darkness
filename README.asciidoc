...
> Sunrise: march for Charlie at Silver Ford.
...
goblets at sunset, so everyone has the opportunity to discuss -- in public --
whatever they like.

Dispatch draws income three times for each mage to get their initial resources
and rituals, privately known before the convocation.  Dispatch also assigns
teams and initial locations for each mage.  Finally, mages each start with
three forces.  They should be named.

Immediately after the convocation (sunset+1), players may send orders or wait
'til sunrise.
