...
and call upon Saturn. On a hit, they're gravely injured. On a +10, nobody
sees you strike.
...
isn't ordered to stay out of a fight is immune to this morale loss, and forced
to fight instead.
...
area and call upon the Sun. On a hit, everything in that area loses a morale.
On a +10, you also gain a morale.
...
Each disciple also starts with six morale, and time to discuss amongst their
team before the first morning turn.
