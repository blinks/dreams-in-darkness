...
Some sample effects:
- Reflect harm back to the dealer inside a specific area.
- Summon a horrible monster with one sphere equal to your margin of success.
- Remotely view another area.
- Cause a group of people to fall asleep.
- Fireball an area.
- Turn yourself invisible.
- Animate the dead.
- Teleport yourself to an area.
...
to increase their score in any sphere, but not past the next bid rank.

.An attribute auction
====
