...
- Fighter: you lead a corps of crusaders, .
...
At the beginning of each turn, the Conduit will contact you. For Ancients, you will get a hand of seven cards drawn at random. If you want to use an ability, you can refuse one of the cards. For Disciples, you will learn about your current situation, including how your plans went last turn, if any.
...
In general, plans succeed unless interrupted. This depends on the card (or cards) granted to the Disciple. If uninterrupted in their area, any card but a 5 succeds. If interrupted, only the higher card succeeds (with Major Arcana lower than Minor Arcana, and 5s lowest of all). Major Arcana also grants a powerful artifact to a Disciple who succeeds.
